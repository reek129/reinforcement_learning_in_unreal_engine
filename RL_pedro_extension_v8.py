...
class DroneAgent():
    ...
    def get_reward(self, collision_info, current_position=None, goal_position=None, lidar_data=None):
...
def testing_DQN2():
    ...
    for episode in range(500):  # Number of episodes
        ...
        for t in range(200):  # Max steps per episode
            ...
            drone_agent.move_by_velocity(velocity[0], velocity[1], velocity[2], 10)  # Move the drone
